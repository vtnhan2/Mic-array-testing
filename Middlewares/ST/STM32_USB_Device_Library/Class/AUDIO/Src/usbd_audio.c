...
#define AUDIO_PACKET_SZE(frq) \
  (uint8_t)(((frq * 2U * 1U) / 1000U) & 0xFFU), (uint8_t)((((frq * 2U * 1U) / 1000U) >> 8) & 0xFFU)  /* Mono for microphone */
#else
#define AUDIO_PACKET_SZE(frq) \
  (uint8_t)(((frq * 2U * 2U) / 1000U) & 0xFFU), (uint8_t)((((frq * 2U * 2U) / 1000U) >> 8) & 0xFFU)  /* Stereo for speaker */
...
__ALIGN_BEGIN static uint8_t USBD_AUDIO_CfgDesc[USB_AUDIO_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x01,                                 /* bTerminalID */
#ifdef USBD_AUDIO_AS_MICROPHONE
  0x01,                                 /* wTerminalType AUDIO_TERMINAL_MICROPHONE   0x0201 */
  0x02,
#else
  ...
  0x01,
#else
  0x01,                                 /* wTerminalType AUDIO_TERMINAL_SPEAKER   0x0301 */
  0x03,
#endif /* USBD_AUDIO_AS_MICROPHONE */
  0x00,                                 /* bAssocTerminal */
  0x02,                                 /* bSourceID */
...
#ifdef USBD_AUDIO_AS_MICROPHONE
  0x03,                                 /* bTerminalLink (Output Terminal ID for microphone) */
#else
  0x01,                                 /* bTerminalLink (Input Terminal ID for speaker) */
#endif /* USBD_AUDIO_AS_MICROPHONE */
  0x01,                                 /* bDelay */
  ...
  /* USB Audio Type III Format Interface Descriptor */
  0x0B,                                 /* bLength */
  AUDIO_INTERFACE_DESCRIPTOR_TYPE,      /* bDescriptorType */
  AUDIO_STREAMING_FORMAT_TYPE,          /* bDescriptorSubtype */
  AUDIO_FORMAT_TYPE_I,                  /* bFormatType */
#ifdef USBD_AUDIO_AS_MICROPHONE
  0x01,                                 /* bNrChannels (Mono for microphone) */
#else
  0x02,                                 /* bNrChannels (Stereo for speaker) */
#endif /* USBD_AUDIO_AS_MICROPHONE */
